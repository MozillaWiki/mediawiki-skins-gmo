...
class SkinGMO extends SkinTemplate {
	...
	function setupSkinUserCss( OutputPage $out ) {
		...
		$out->addStyle( '../extensions/gmo/skins/gmo/style/screen.css', 'screen, projection' );
		$out->addStyle( '../extensions/gmo/skins/gmo/style/enhanced.css', 'screen, projection' );
		$out->addStyle( '../extensions/gmo/skins/gmo/style/mediawiki.css', 'screen, projection' );
		$out->addStyle( '../extensions/gmo/skins/gmo/style/ie.css', 'screen, projection', 'gte IE 6');
	}
}
...
<head>
	...
	<script type="text/javascript">
	  ...
	  var _gaq = _gaq || [];
	  _gaq.push(['_setAccount', 'UA-35433268-22']);
...
<div id="footer-wrap">
	<div class="cols" id="footer">
		<div class="six-col">
			<a href="/" id="logo-footer"><img src="<?php echo $wgStylePath; ?>/../extensions/gmo/skins/gmo/img/screen/template/screen/logo_footer.png"></a>
		</div>
		<div class="col-span">
